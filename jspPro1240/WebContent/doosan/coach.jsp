...
function check() {
	var coaches = document.input.coaches.value;
	if(coaches == "") {
		alert("초성을 선택해주세요.");
		document.input.coaches.focus();
		return;
    }
...
<form name="input" method="post" action="coach2.jsp">
<div id="doosan">
	<header>
		<div class="mainTop">
	...
	<h1 style="text-align: center;"> 원하는 코치의 성의 초성을 선택하세요. </h1>
	<select style="margin-left: 900px;" name="coaches" multiple size="10">
